...
replace (
	...
	github.com/google/go-sev-guest => github.com/edgelesssys/go-sev-guest v0.0.0-20250402104424-deaf0dfccf3c
)
...
require (
	...
	github.com/edgelesssys/contrast v1.7.1-0.20250414130625-d19979c4ffa6
