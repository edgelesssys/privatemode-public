...
var (
	dhKEMP256   = &dhKEM{HKDFSHA256(), 0x0010, ecdh.P256(), 32, 32, 65}
	dhKEMP384   = &dhKEM{HKDFSHA384(), 0x0011, ecdh.P384(), 48, 48, 97}
	dhKEMP521   = &dhKEM{HKDFSHA512(), 0x0012, ecdh.P521(), 64, 66, 133}
	dhKEMX25519 = &dhKEM{HKDFSHA256(), 0x0020, ecdh.X25519(), 32, 32, 32}
)
